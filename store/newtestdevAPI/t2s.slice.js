...
export const api_v1_t2_list = createAsyncThunk(
  "t2s/api_v1_t2_list",
  async payload => {
...
export const api_v1_t2_create = createAsyncThunk(
  "t2s/api_v1_t2_create",
  async payload => {
    const response = await apiService.api_v1_t2_create(payload)
    return response.data
  }
)
export const api_v1_t2_retrieve = createAsyncThunk(
  "t2s/api_v1_t2_retrieve",
  async payload => {
    const response = await apiService.api_v1_t2_retrieve(payload)
    return response.data
  }
)
export const api_v1_t2_update = createAsyncThunk(
  "t2s/api_v1_t2_update",
  async payload => {
    const response = await apiService.api_v1_t2_update(payload)
    return response.data
  }
)
export const api_v1_t2_partial_update = createAsyncThunk(
  "t2s/api_v1_t2_partial_update",
  async payload => {
    const response = await apiService.api_v1_t2_partial_update(payload)
    return response.data
  }
)
export const api_v1_t2_destroy = createAsyncThunk(
  "t2s/api_v1_t2_destroy",
  async payload => {
...
const t2sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(api_v1_t2_list.pending, (state, action) => {
