...
export const api_v1_t1_list = createAsyncThunk("t1s/api_v1_t1_list", async payload => {
  const response = await apiService.api_v1_t1_list(payload);
  return response.data;
});
export const api_v1_t1_create = createAsyncThunk("t1s/api_v1_t1_create", async payload => {
  const response = await apiService.api_v1_t1_create(payload);
  return response.data;
});
export const api_v1_t1_retrieve = createAsyncThunk("t1s/api_v1_t1_retrieve", async payload => {
  const response = await apiService.api_v1_t1_retrieve(payload);
  return response.data;
});
export const api_v1_t1_update = createAsyncThunk("t1s/api_v1_t1_update", async payload => {
  const response = await apiService.api_v1_t1_update(payload);
  return response.data;
});
export const api_v1_t1_partial_update = createAsyncThunk("t1s/api_v1_t1_partial_update", async payload => {
  const response = await apiService.api_v1_t1_partial_update(payload);
  return response.data;
});
export const api_v1_t1_destroy = createAsyncThunk("t1s/api_v1_t1_destroy", async payload => {
...
const t1sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_t1_list.pending, (state, action) => {
